document.addEventListener("DOMContentLoaded", function () {
  ...
  const swiperSlidersliderName = new Swiper(".slider-tile .swiper", {
    ...
    navigation: {
      nextEl:
        ".btn-action-ico.ico-arrow.ico-arrow-next.button-slider-tile-next",
      prevEl:
        ".btn-action-ico.ico-arrow.ico-arrow-prev.button-slider-tile-prev",
    },
  });
  ...
  const swiperSliderReviews = new Swiper(".slider-reviews .swiper", {
    ...
    navigation: {
      nextEl:
        ".btn-action-ico.ico-arrow.ico-arrow-next.button-slider-reviews-next",
      prevEl:
        ".btn-action-ico.ico-arrow.ico-arrow-prev.button-slider-reviews-prev",
    },
  });
  ...
  const swiperSliderInfo = new Swiper(".slider-info .swiper", {
    ...
    navigation: {
      nextEl:
        ".btn-action-ico.ico-arrow.ico-arrow-next.button-slider-info-next",
      prevEl:
        ".btn-action-ico.ico-arrow.ico-arrow-prev.button-slider-info-prev",
    },
  });
